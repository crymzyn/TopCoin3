...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TopCoin3 " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"nlab", "top01.nerdlabs001.com"},
    {"nlab", "top02.nerdlabs001.com"},
    {"nlab", "top03.nerdlabs001.com"},
    {"nlab", "top04.nerdlabs001.com"},
    {"nlab", "top05.nerdlabs001.com"},
    {"nlab", "top06.nerdlabs001.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TopCoin3 is probably already running."), addrBind.ToString().c_str());
        else
